...
//     const matchesType = filterType === "" || filterType === resource.type;
...
//       <div className="max-w-screen-xl mx-auto px-4 py-12 z-10 relative flex-wrap">
...
//         <div className="flex gap-20 mt-20 mt-6 flex-wrap justify-center">
//           <button
//             onClick={() => setFilterType("hero")}
//             className={`w-40  py-2 rounded-full border ${
//               filterType === "hero" ? "bg-blue-500 text-white" : "bg-transparent text-bg-[#B5B5B5] border-[#B5B5B5]"
...
//             className={`w-40 py-2 rounded-full border ${
//               filterType === "movie" ? "bg-blue-500 text-white" : "bg-transparent text-bg-[#B5B5B5] border-[#B5B5B5]"
//             } hover:bg-blue-600 hover:border-blue-600 transition-all`}
//           >
//             Movies
//           </button>
...
//                 : "bg-transparent text-bg-[#B5B5B5] border-[#B5B5B5]"
//             } hover:bg-blue-600 hover:border-blue-600 transition-all`}
//           >
//             Documentaries
//           </button>
...
//             className={`w-40  py-2 rounded-full border ${
//               filterType === "quote" ? "bg-blue-500 text-white" : "bg-transparent text-bg-[#B5B5B5] border-[#B5B5B5]"
//             } hover:bg-blue-600 hover:border-blue-600 transition-all`}
//           >
//             Quotes
//           </button>
      ...
      <div className="max-w-screen-xl mx-auto px-4 py-12 z-10 relative">
        ...
        <div className="flex gap-4 mt-6 flex-wrap justify-center">
          <button
            onClick={() => setFilterType("hero")}
            className={`w-40 py-2 rounded-full border ${
              filterType === "hero" ? "bg-blue-500 text-white" : "bg-transparent text-[#B5B5B5] border-[#B5B5B5]"
            } hover:bg-blue-600 hover:border-blue-600 transition-all`}
          >
            Heroes
          </button>
          <button
            onClick={() => setFilterType("movie")}
            className={`w-40 py-2 rounded-full border ${
              filterType === "movie" ? "bg-blue-500 text-white" : "bg-transparent text-[#B5B5B5] border-[#B5B5B5]"
            } hover:bg-blue-600 hover:border-blue-600 transition-all`}
          >
            Movies
          </button>
          <button
            onClick={() => setFilterType("documentary")}
            className={`w-40 py-2 rounded-full border ${
              filterType === "documentary" ? "bg-blue-500 text-white" : "bg-transparent text-[#B5B5B5] border-[#B5B5B5]"
            } hover:bg-blue-600 hover:border-blue-600 transition-all`}
          >
            Documentaries
          </button>
          <button
            onClick={() => setFilterType("quote")}
            className={`w-40 py-2 rounded-full border ${
              filterType === "quote" ? "bg-blue-500 text-white" : "bg-transparent text-[#B5B5B5] border-[#B5B5B5]"
            } hover:bg-blue-600 hover:border-blue-600 transition-all`}
          >
            Quotes
          </button>
