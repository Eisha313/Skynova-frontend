...
//     if (resultScore > totalQuestions / 2) { // Check if the score is more than 50%
//       if (completedQuizCount === 1) {
//         certificateTitle = 'Basic Certificate';
//       } else if (completedQuizCount === 2) {
//         certificateTitle = 'Medium Certificate';
//       } else if (completedQuizCount === 3) {
//         certificateTitle = 'Advanced Certificate';
//       }
  
//       // Create the certificate if the title is determined
//       if (certificateTitle) {
//         await fetch(`https://sky-nova-8ccaddc754ce.herokuapp.com/certificates/createCertificate`, {
//           method: 'POST',
//           headers: {
//             'Content-Type': 'application/json',
//             Authorization: `Bearer ${token}`,
...
//   }, [timeLeft, quiz, quizFinished, currentQuestion]);
