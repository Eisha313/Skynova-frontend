...
// //   return (
// //     <div className="bg-gray-900 min-h-screen p-8 text-white overflow-y-auto">
// //       <h1 className="text-2xl mb-6">Detailed Results</h1>
// //       {results.map((result, resultIndex) => (
// //         <div key={resultIndex} className="mb-8">
// //           <h2 className="text-xl mb-4"> Score: {result.marks}</h2>
...
//       {results.map((result, resultIndex) => (
//         <div key={resultIndex} className="mb-8">
//           <h2 className="text-xl mb-4">Attempt {resultIndex + 1} - Score: {result.marks}</h2>
//           {result.quizId.questions.map((question, index) => (
//             <div key={index} className="mb-6">
//               <p className="mb-2">Question {index + 1}: {question.text}</p>
//               {question.options.map((option, i) => {
