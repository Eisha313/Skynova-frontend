...
//                <span className={`inline-block px-4 py-2 rounded text-lg font-semibold ${jet.status === 'Active' ? 'bg-green-500 text-white' : 'bg-red-500 text-white'}`}>
//                 {jet.status}
//                 </span>
//                </td>

//                 <td className="py-2  border-b border-gray-200 text-center flex justify-center items-center space-x-2">
...
//           <img src={selectedJet.imageURL} alt={selectedJet.name} className="w-full h-auto mt-4" />
//         </Modal>
//       )}
//     </div>
//   );
