    ...
    <div className="overflow-x-auto " >
      <div className="flex flex-col md:flex-row md:justify-between items-center mb-4 space-y-4 md:space-y-0">
        ...
        <div className="flex flex-1 justify-end space-x-2">
          ...
          >
            <option className='bg-[#c5cbe4] text-black'value="all">All</option>
            <option className='bg-[#c5cbe4] text-black' value="verbal">Verbal</option>
            <option className='bg-[#c5cbe4] text-black'value="nonverbal">Nonverbal</option>
          </select>
