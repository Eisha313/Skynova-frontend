...
export default function Footer() {
  return (
    <footer className="bg-eisha text-white pt-20 py-8 w-full">
      <div className="container mx-auto w-full flex flex-col items-center space-y-6">
        <div className="space-x-6">
          ...
          <a href="/userRender/privacyPolicy" className="hover:underline">
            Privacy Policy
          </a>
          <a href="/careers" className="hover:underline">
            Careers
          </a>
          <a href="/userRender/AboutUs" className="hover:underline">
            About Us
          </a>
          <a href="/blogs" className="hover:underline">
            Blogs
          </a>
          <a href="/userRender/privacy/contact" className="hover:underline">
            Contact Us
          </a>
        </div>
