    ...
    <section className="bg-gray-900 text-white py-12">
      <div className="mx-auto px-4">
        ...
        {missions.map((mission, index) => (
          <div key={index} className={`flex flex-col md:flex-row items-center mb-12 h-96 relative overflow-hidden`}>
            <div
              className={`w-[63%] absolute top-0 bottom-0  ${
                index % 2 === 0 ? "landing-page-image-container left-0" : "landing-page-image-container-reverse right-0"
              }`}
            >
            ...
            >
              ...
              <button
                onClick={() => handleDownload(mission.link)}
                className="bg-[#5AA0BC]  rounded-lg text-white px-6 py-2 w-[200px]  hover:bg-blue-600 transition w-fit"
              >
                Download
              </button>
            </div>
