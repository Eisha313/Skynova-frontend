...
const WelcomeAviators = () => {
  return (
    <section className="relative bg-[#0B1226] text-white py-16 px-6 overflow-hidden">
      ...
      {/* Content Section */}
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between mt-16 mx-auto px-8 max-w-[1000px] lg:max-w-[80%] ml-40">
  {/* Text Section */}
  <div className="lg:w-[60%] text-center lg:text-left px-6">
    <h3 className="text-4xl md:text-6xl font-bold text-[#5AA0BC]">
      SkyNova
    </h3>
