...
// //         </NavItem>
// //         <NavItem href="/verbalquiz" text="Manage Quizzes" icon={<FaPlane />} currentPath={currentPath} />
...
//         <NavItem text="Manage Resources" icon={<FaTasks />} currentPath={currentPath}>
//           <NavItem href="/addResource" text="Add Resource" icon={<FaBrain />} currentPath={currentPath} />
//           <NavItem href="/ViewResource" text="View Resource" icon={<FaBook />} currentPath={currentPath} />
//         </NavItem>
...
//         <NavItem href="/view-resource" text="Manage Resource" icon={<FaCogs />} currentPath={currentPath} />
//       </div>
//     </DropdownProvider>
//   );
// };
