...
// import React from 'react';
// import { QuizDetail } from './manageQuiz'; // Adjust this import to your actual path

// interface QuizModalProps {
//   isOpen: boolean;
//   onClose: () => void;
//   quizDetails: QuizDetail | null; // Use QuizDetail here
// }
...
//         <p className="mb-2"><strong>Description:</strong> {quizDetails.description}</p>
//         {/* Add more details as needed */}
//         <button
//           onClick={onClose}
//           className="mt-4 py-2 px-4 bg-blue-600 text-white font-bold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
...
import React from 'react';
import { QuizDetail } from './manageQuiz'; // Adjust the path as needed
