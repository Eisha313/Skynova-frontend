  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-4xl mx-auto p-8 bg-gray-100 rounded-lg shadow-xl">
      ...
      <div className="flex justify-between mt-8">
        ...
        <Link
          href="/viewuser"
          className="w-full md:w-auto px-6 py-3 text-gray-700 font-semibold rounded-lg border border-gray-300 shadow-sm hover:bg-gray-200 focus:ring-2 focus:ring-gray-500"
        >
          Cancel
        </Link>
      </div>
