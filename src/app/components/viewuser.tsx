...
//       try {
//         const response = await fetch(`http://192.168.18.26:3000/aviators/viewAviators?page=${currentPage}`);
...
//         console.log('mapped users are', mappedUsers);
    
//         setUsers([...mappedUsers]);
//         setFilteredUsers([...mappedUsers]);
//         console.error('filtered are:', filteredUsers);
//       } catch (error) {
...
//   useEffect(() => {
//     console.log('FilteredUsers state has been updated:', filteredUsers);
//   }, [filteredUsers]);
...
//     try {
//       const response = await fetch(`http://192.168.18.26:3000/aviators/updateAviator/${userId}`, {
//         method: 'PATCH',
...
//         </div>
//         <div className="flex space-x-4">
//           <Link href="/addaviator" className="bg-blue-500 text-white px-4 py-2 rounded-md">Add User</Link>
//           <Pagination
