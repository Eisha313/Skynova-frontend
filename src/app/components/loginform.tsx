  ...
  return (
    <div className="w-full max-w-md bg-white p-4 rounded-lg shadow-md border border-gray-200">
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="w-full p-2 bg-eisha text-white rounded mt-4">
          Log In
        </button>
      </form>
      ...
      <div className="flex justify-center mt-2">
        <button onClick={() => handleOAuthSignIn("google")} className="p-2 bg-white text-white rounded mx-2">
          <Image src="/google.svg" alt="Google" width={20} height={20} className="rounded-full" />
        </button>
        <button onClick={() => handleOAuthSignIn("github")} className="p-2 bg-white text-white rounded mx-2">
          <Image src="/github.png" alt="GitHub" width={20} height={20} className="rounded-full bg-black" />
        </button>
      </div>
