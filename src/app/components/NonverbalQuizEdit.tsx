        ...
        <div key={index} className="mb-4">
          ...
          <input
            ...
            onChange={(e) => handleQuestionChange(index, { ...question, answer: e.target.value })}
             ...
             flex-grow className="w-full px-4 py-2 mt-8 text-white border border-white/30 rounded-xl bg-transparent hover:border-[#5AA0BC] active:border-[#5AA0BC] focus-visible:border-[#5AA0BC] transition-all outline-none"
          />
        </div>
      ))}
      <button
